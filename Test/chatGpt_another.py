...
BLOCK_SIZE = 4410    # Number of audio samples per block
...
input_stream = sd.InputStream(callback=None, device=2,channels=CHANNELS, samplerate=SAMPLE_RATE)
output_stream = sd.OutputStream(callback=None, device=4,channels=CHANNELS, samplerate=SAMPLE_RATE)
...
recorded_data_thread.daemon = True
played_data_thread.daemon = True

capture_thread.start()
play_thread.start()
recorded_data_thread.start()
played_data_thread.start()
